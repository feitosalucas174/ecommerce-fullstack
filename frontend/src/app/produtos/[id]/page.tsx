    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <nav className="mb-6 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          <span>/</span>
          <Link href="/produtos" className="hover:text-blue-600 dark:hover:text-blue-400">Produtos</Link>
          <span>/</span>
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          {/* Image */}
          <div className="relative h-96 overflow-hidden rounded-2xl bg-gray-100 dark:bg-gray-800">
            {product.image_url ? (
          ...
          <div className="flex flex-col">
            <span className="inline-block rounded-full bg-blue-100 dark:bg-blue-900/40 px-3 py-1 text-xs font-medium text-blue-700 dark:text-blue-300 w-fit">
              ...
              <div className="mt-6 flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                  >
                    −
                  </button>
